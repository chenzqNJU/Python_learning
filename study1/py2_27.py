import you_get
you_get http://www.bilibili.com/video/av7609367/

you_get http://www.bilibili.com/video/av7609367/
import os
os.system('pip install you-get')
os.system(r"you-get -p PotPlayerMini.exe https://d1.xia12345.com/d/113/2018/02/R5e3JCtQ.mp4")

os.system('dir e:\\')
os.system('del f:\\2.txt')
os.system('rd f:\\2')
...
cmd_download('http://open.163.com/movie/2016/4/H/1/MBKJ0DQ52_MBKJ0MDH1.html','线性代数中的几何学')
# 课程首页 url
# 线性代数 url
