...
class get_stock_data():
    ...
    # data_get.get_train_test_data_new(batch_size=200, file_path=train_csv_path)
...
class Deeplearing():
    ...
    def stock_lstm(self,):
        ...
        model_save_path = "e:\\tf\\save\\stock_rnn_save.ckpt"#os.path.join(basic_path, "stock_rnn_save.ckpt")
